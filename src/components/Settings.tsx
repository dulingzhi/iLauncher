  ...
  return (
    <div className="h-full bg-gray-900 text-white p-6 overflow-y-auto">
      <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
                    {['dark', 'light', 'blue', 'purple', 'green'].map((themeName) => (
                      <button
                        ...
                        className={`py-2 px-2 rounded-lg border-2 transition-colors text-xs ${
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Theme changes are applied immediately. Click "Save Settings" to persist.
                  </p>
                </div>
        ...
        {activeTab === 'plugins' && (
          <div className="bg-gray-800 rounded-lg p-4">
            <h2 className="text-lg font-semibold mb-3">Plugin Settings</h2>
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-gray-700 rounded">
                <div>
                  <div className="font-medium text-sm">Start on System Boot</div>
                  <div className="text-xs text-gray-400">Launch iLauncher when Windows starts</div>
                </div>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-700 rounded">
                <div>
                  <div className="font-medium text-sm">Show Tray Icon</div>
                  <div className="text-xs text-gray-400">Display icon in system tray</div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
              ...
              <div className="flex items-center justify-between p-3 bg-gray-700 rounded">
                <div>
                  ...
                  <div className="text-xs text-gray-400">Help improve iLauncher by sharing usage data</div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input 
                    type="checkbox" 
        ...
        <div className="mt-6 flex justify-end gap-3 pb-4">
          ...
          <button
            onClick={handleSave}
            className="px-5 py-2 bg-blue-600 hover:bg-blue-700 rounded text-sm font-medium transition-colors disabled:opacity-50"
            disabled={saving}
          >
